...
//    string moves = "";
//    int attempts = 0;
//    const int maxAttempts = 24; // Prevent infinite loops
//
//    while (!checkFirstLayerCorner(green, white, yellow, red, orange, blue) && attempts < maxAttempts) {
//        attempts++;
//        // Check current position for white corner
//        if (yellow[2][2] == 'w' || green[0][2] == 'w' || orange[0][0] == 'w') {
//            if (yellow[2][2] == 'w') {
//                // White on yellow face
//                if (green[0][2] == green[1][1] && orange[0][0] == orange[1][1]) {
...
//        }
//        else {
//            // Rotate to bring another corner into position
...
//}
//bool checkFirstLayerCorner(char green[3][3], char white[3][3], char yellow[3][3], char red[3][3], char orange[3][3], char blue[3][3]) {
//    // Check if all white corners are in place and adjacent colors match
//    return (white[0][0] == 'w' && white[0][2] == 'w' && white[2][0] == 'w' && white[2][2] == 'w' &&
//        green[2][0] == green[1][1] && green[2][2] == green[1][1] &&
//        red[2][0] == red[1][1] && red[2][2] == red[1][1] &&
//        orange[2][0] == orange[1][1] && orange[2][2] == orange[1][1] &&
//        blue[2][0] == blue[1][1] && blue[2][2] == blue[1][1]);
//}
//
