...
void firstLayer(char g[3][3], char w[3][3], char y[3][3], char r[3][3], char o[3][3], char b[3][3]);

bool checkFirstLayerCorner(char g[3][3], char w[3][3], char y[3][3], char r[3][3], char o[3][3], char b[3][3]);
